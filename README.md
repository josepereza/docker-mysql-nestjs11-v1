...
Mapeo de Puertos	Expone un puerto del contenedor a un puerto de tu VPS.	docker run -p [Puerto_VPS]:[Puerto_Contenedor] ...
Firewall (UFW)	Permite tráfico en el puerto mapeado.	sudo ufw allow 8080/tcp
...
docker-compose exec mysql mysqldump -u root -p mysql_password nestapp > backup.sql
